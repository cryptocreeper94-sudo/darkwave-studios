...
IMPORTANT: Return ONLY valid JSON, no markdown formatting.`;
  ...
  const ecosystemHealthTargets = [
    ...
    { id: "signal-chat", name: "ChronoChat", url: "https://signalchat.tlid.io", category: "social", loc: "~4K", pages: "2" },
  ...
  app.get("/api/ecosystem/widget-data", async (req, res) => {
    try {
      const ecosystemAppsData = [
        ...
        { displayName: "ChronoChat", description: "Encrypted real-time messaging", icon: "SC", isVerified: true },
