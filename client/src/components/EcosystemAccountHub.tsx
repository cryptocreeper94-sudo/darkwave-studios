...
const BONUSES = [
  ...
  { id:'vault',      app:'Axiom42 Suite',    icon:'🔐', headline:'Secure the Network',     reward:'Refer friends to Axiom42 Suite',   sig:600,  mult:'2×', perk:'Vault tier',       url:'https://axiom42suite.studio',             ac:'#06b6d4', gl:'rgba(6,182,212,0.07)',  s:'2026-05-19', e:'2026-06-02' },
...
const APPS = [
  ...
  { n:'Axiom42 Suite',  u:'https://axiom42suite.studio',     i:'🔐' },
...
const S = {
  trigger: (open: boolean) => ({
    position: 'fixed' as const, top: 14, right: 14, zIndex: 9998,
