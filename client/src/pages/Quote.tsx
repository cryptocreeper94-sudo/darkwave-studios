                    ...
                    {features.map((feature) => (
                      <button
                        ...
                        className={`p-3 lg:p-4 rounded-xl border-2 transition-all text-left relative min-h-[70px] lg:min-h-[90px] ${
                          selectedFeatures.includes(feature.id) 
                            ? "border-primary bg-primary/10" 
                            : "border-white/[0.08] bg-white/5 hover:border-white/[0.1]"
                        }`}
                      ...
                      >
                        <div className={`absolute top-2 right-2 w-5 h-5 rounded-md border-2 flex items-center justify-center ${
                          selectedFeatures.includes(feature.id) ? "border-primary bg-primary" : "border-white/[0.15]"
                        }`}>
              ...
              <GlassCard className="rounded-2xl lg:rounded-3xl p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/[0.08] focus:border-primary focus:outline-none"
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/[0.08] focus:border-primary focus:outline-none resize-none"
                    rows={1}
              ...
              <GlassCard glow className="rounded-2xl lg:rounded-3xl p-6 bg-gradient-to-br from-primary/5 to-accent/5">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  {selectedFeatures.map(id => {
                    ...
                    return feature ? (
                      <div key={id} className="flex items-center justify-between py-2 border-b border-white/[0.08]">
