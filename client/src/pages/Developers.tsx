...
const developerProducts = [
  ...
  },
  {
    ...
    description: "Blockchain-verified widget marketplace with 102 embeddable components for analytics, booking, lead capture, media editing, AI tools, and more.",
    icon: Boxes,
    href: "/hub",
  ...
  },
  {
    ...
    description: "Centralized UI component manager. Update footers, headers, banners, and badges once — changes propagate to all 38 ecosystem apps instantly.",
    icon: Layers,
  ...
  },
  {
    ...
    description: "Real-time health dashboard for all 38 production apps. Live status checks, response times, uptime ring, and category filtering across the entire ecosystem.",
    icon: Activity,
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-sm text-muted-foreground">Lead with the story — solo developer building a 37-app, 1.86M+ line ecosystem is compelling and rare</p>
                    </div>
                    <div className="flex items-start gap-2">
                      <div className="w-5 h-5 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
