  ...
  return (
    <div className="min-h-screen bg-[#06060a] text-white overflow-x-hidden">
      <SEOHead
        ...
        description="The deterministic natural-language programming language. 82 source modules, 2,331 passing tests, Ed25519 trust certificates, 31-rule inference engine, 3 Zenodo publications (DAIGS). Write English, ship JavaScript. Built by DarkWave Studios."
