...
export default function Lume() {
  return (
    <div className="min-h-screen bg-[#06060a] text-[#050505] overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-[#06060a]/80 backdrop-blur-xl border-b border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/" className="text-[#888] hover:text-[#888] transition-colors" data-testid="link-home">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs px-2 py-0.5 rounded-full bg-white/10 text-[#888] font-semibold">v1.1.0</span>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg text-sm font-medium bg-white/5 hover:bg-white/10 border border-white/[0.08] transition-colors text-gray-300 hover:text-[#050505]"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 bg-white/5 border border-white/[0.08] text-[#050505] px-2.5 sm:px-3 py-1.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity"
      ...
      <main>
        ...
        <section className="relative py-20 lg:py-32 overflow-hidden" data-testid="section-hero">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/[0.08] text-sm text-[#888] mb-6" data-testid="badge-ecosystem">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-[#888] max-w-3xl mx-auto mb-8 leading-relaxed px-2" data-testid="text-hero-tagline">
                The first language where artificial intelligence is a <span className="text-[#888] font-semibold">syntax primitive</span> — not a library import.
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <Link
                  ...
                  className="inline-flex items-center gap-2 bg-white/5 border border-white/[0.08] text-[#050505] px-6 py-3 rounded-xl font-semibold text-lg hover:opacity-90 transition-opacity shadow-[0_10px_30px_rgba(0,0,0,0.5)] shadow-cyan-500/25"
              ...
              <Link
                href="/lume/library"
                className="group relative px-5 py-2.5 rounded-xl bg-white/5 border border-white/[0.08] text-[#050505]/70 text-sm font-semibold hover:bg-white/10 transition-all duration-300 hover:scale-105"
              >
                Widget Library
                </Link>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/[0.08] text-[#050505] px-6 py-3 rounded-xl font-semibold text-lg transition-colors"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold mb-4" style={{ fontFamily: "Inter, sans-serif" }} data-testid="heading-ai-syntax">
                <span className="bg-white/5 border border-white/[0.08] bg-clip-text text-transparent">AI as Syntax</span>
              </h2>
              ...
              >
                <GlassCard glow className="p-6 rounded-2xl h-full">
                  <div className="flex items-center gap-2 mb-4">
                    <div className="w-6 h-6 rounded bg-white/5 border border-white/[0.08] flex items-center justify-center">
                      <Zap className="w-3.5 h-3.5 text-[#050505]" />
                    </div>
                    <span className="text-sm font-semibold text-[#888]">Lume — 5 lines</span>
                  </div>
              ...
              {pipelineSteps.map((step, i) => (
                ...
                >
                  <GlassCard glow className="p-3 sm:p-4 rounded-xl text-center h-full" data-testid={`pipeline-step-${i}`}>
                    <step.icon className="w-5 h-5 sm:w-6 sm:h-6 text-[#888] mx-auto mb-1.5 sm:mb-2" />
                    <div className="text-xs sm:text-sm font-semibold text-[#050505]" style={{ fontFamily: "JetBrains Mono, monospace" }}>{step.label}</div>
                    <div className="text-[10px] sm:text-[11px] text-[#888] mt-1 hidden sm:block">{step.desc}</div>
                  </GlassCard>
              ...
              {runtimeLayers.map((layer, i) => (
                <motion.div key={layer.name} variants={staggerItem}>
                  <GlassCard glow className="p-6 rounded-2xl h-full" data-testid={`runtime-layer-${i}`}>
                    ...
                    <p className="text-sm text-[#888] leading-relaxed">{layer.desc}</p>
                  </GlassCard>
                </motion.div>
              ))}
            </motion.div>
            ...
            >
              {toolchainCommands.map((tool) => (
                <motion.div key={tool.cmd} variants={staggerItem}>
                  <GlassCard className="p-5 rounded-xl group hover:border-white/[0.08] transition-all" data-testid={`tool-${tool.cmd}`}>
                ...
                <motion.div key={m.name} variants={staggerItem}>
                  <GlassCard className="p-5 rounded-xl" data-testid={`milestone-${i}`}>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-[#888] font-semibold" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                        {m.tests}/{m.total}
                      </span>
                    </div>
                    <div className="w-full h-2 rounded-full bg-white/5 overflow-hidden">
                      <motion.div
                        className="h-full rounded-full bg-white/5 border border-white/[0.08]"
                        initial={{ width: 0 }}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold mb-4" style={{ fontFamily: "Inter, sans-serif" }} data-testid="heading-ecosystem">
                <span className="bg-white/5 border border-white/[0.08] bg-clip-text text-transparent">Ecosystem Integration</span>
              </h2>
              <p className="text-[#888] text-lg max-w-2xl mx-auto">
              ...
              {ecosystemIntegrations.map((item) => (
                <motion.div key={item.name} variants={staggerItem}>
                  <GlassCard glow className="p-5 rounded-xl h-full" data-testid={`integration-${item.name.toLowerCase().replace(/\s+/g, '-')}`}>
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-500/20 to-teal-500/20 border border-white/[0.08] flex items-center justify-center mb-3">
              ...
              {connectedApps.map((app) => (
                <motion.div key={app.name} variants={staggerItem}>
                  <a href={app.url} target="_blank" rel="noopener noreferrer">
                    <GlassCard className="p-5 rounded-xl group hover:border-white/[0.08] transition-all cursor-pointer h-full" data-testid={`app-${app.name.toLowerCase().replace(/\s+/g, '-')}`}>
                      <div className="flex items-center justify-between mb-2">
                        <h3 className="text-sm font-bold text-[#050505] group-hover:text-[#888] transition-colors">{app.name}</h3>
                        <ExternalLink className="w-4 h-4 text-[#888] group-hover:text-[#888] transition-colors" />
                      </div>
                      <p className="text-xs text-[#888] leading-relaxed">{app.desc}</p>
                    </GlassCard>
                  </a>
                </motion.div>
              ))}
            ...
            <GlassCard variant="elevated" className="p-6 rounded-2xl">
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 sm:gap-6">
                {stats.map((stat) => (
                  ...
                  >
                    <div className="text-lg sm:text-2xl lg:text-3xl font-bold bg-white/5 border border-white/[0.08] bg-clip-text text-transparent" style={{ fontFamily: "JetBrains Mono, monospace" }}>
                      {stat.value}
                    </div>
                    <div className="text-[10px] sm:text-xs text-[#888] mt-1">{stat.label}</div>
                  </motion.div>
                ))}
              </div>
            </GlassCard>
        ...
        <section className="py-16 lg:py-24" data-testid="section-nl-roadmap">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/[0.08] text-sm text-[#888] mb-6" data-testid="badge-nl-evolution">
                <Sparkles className="w-4 h-4 text-[#888]" />
                Milestones 7-13
              </div>
              ...
              {nlRoadmap.map((milestone, i) => (
                <motion.div key={milestone.id} variants={staggerItem}>
                  <GlassCard
                    ...
                    className={`p-5 sm:p-6 rounded-2xl ${milestone.status === "complete" ? "border-green-500/20" : milestone.status === "active" ? "border-white/[0.08]" : ""}`}
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                      <div className="flex items-center gap-3 sm:min-w-[200px]">
                        <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${
                          ...
                          <milestone.icon className={`w-5 h-5 ${milestone.status === "active" ? "text-[#050505]" : "text-[#888]"}`} />
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
                            <span className="text-xs font-bold text-[#888]" style={{ fontFamily: "JetBrains Mono, monospace" }}>{milestone.id}</span>
                            {milestone.status === "complete" ? (
                              ...
                              <span className="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-white/10 text-[#888]" data-testid={`status-${milestone.id.toLowerCase()}`}>
                                <CircleDot className="w-2.5 h-2.5" /> Active
                              </span>
                            ) : (
                              <span className="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-full bg-white/5 text-[#888]" data-testid={`status-${milestone.id.toLowerCase()}`}>
                                <Clock className="w-2.5 h-2.5" /> Planned
                              </span>
                            )}
                          </div>
                          <h3 className={`text-sm sm:text-base font-bold mt-0.5 ${milestone.status === "active" ? "text-[#050505]" : "text-[#888]"}`} style={{ fontFamily: "Inter, sans-serif" }}>
                            {milestone.name}
                          </h3>
                        </div>
                      </div>
                      <div className="flex-1">
                        <p className={`text-sm leading-relaxed mb-3 ${milestone.status === "active" ? "text-gray-300" : "text-[#888]"}`}>
                          {milestone.desc}
                        </p>
                            ...
                            <span
                              ...
                              className={`text-[10px] sm:text-xs px-2 py-1 rounded-md font-medium ${
                                milestone.status === "active"
                                  ...
                                  : "bg-white/5 text-[#888] border border-white/[0.05]"
                              }`}
                            >
                              {cap}
                            </span>
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-center gap-3 sm:gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white/5 border border-white/[0.08] text-[#050505] px-4 sm:px-6 py-3 rounded-xl font-semibold text-sm sm:text-base hover:opacity-90 transition-opacity shadow-[0_10px_30px_rgba(0,0,0,0.5)] shadow-cyan-500/25 col-span-2"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/[0.08] text-[#050505] px-4 sm:px-6 py-3 rounded-xl font-semibold text-sm sm:text-base transition-colors"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/[0.08] text-[#050505] px-4 sm:px-6 py-3 rounded-xl font-semibold text-sm sm:text-base transition-colors col-span-2 sm:col-span-1"
