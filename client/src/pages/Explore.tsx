...
const categories: ExploreCategory[] = [
  ...
  },
  {
    ...
    description: "Explore the full Trust Layer ecosystem — 42 interconnected apps, a portfolio of live projects, and detailed codebase metrics across 1.86M+ lines of code.",
    cards: [
      {
        label: "Ecosystem",
