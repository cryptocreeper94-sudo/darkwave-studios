...
export default function Payment() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-foreground overflow-x-hidden">
      ...
      />
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/[0.03] backdrop-blur-xl border-b border-white/[0.05]">
        ...
        <div className="grid grid-cols-3 lg:grid-cols-12 gap-4 lg:gap-6">
            ...
            <div className="col-span-3 lg:col-span-12 flex flex-row gap-4">
              {monthlyPlans.map((plan) => (
                <div 
                  ...
                  className={`flex-1 min-w-0 rounded-2xl overflow-hidden cursor-pointer transition-all relative border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl ${
          ...
          {activeTab === "onetime" && oneTimePlans.map((plan) => (
            <div 
              key={plan.id}
              onClick={() => setSelectedPlan(plan.id)}
              className={`col-span-3 lg:col-span-6 rounded-2xl lg:rounded-3xl overflow-hidden cursor-pointer transition-all border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl ${
                selectedPlan === plan.id 
                  ? "ring-2 ring-primary bg-primary/10" 
                  : "hover:bg-white/5"
              }`}
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/[0.08] focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
              ...
              <GlassCard glow className="col-span-3 lg:col-span-12 p-6 lg:p-8 bg-gradient-to-br from-primary/5 to-accent/5">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                  ...
                  <button
                    ...
                    className="glow-button w-full lg:w-auto px-8 py-4 bg-gradient-to-r from-primary to-accent text-[#050505] font-bold rounded-xl flex items-center justify-center gap-3 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5)] hover:shadow-primary/25 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
