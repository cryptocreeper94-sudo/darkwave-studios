      ...
      <div className="min-h-screen bg-[#050505] text-foreground flex items-center justify-center px-4">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/" className="glow-button px-6 py-3 bg-gradient-to-r from-primary to-accent text-[#050505] font-bold rounded-xl flex items-center justify-center gap-2" data-testid="link-home">
