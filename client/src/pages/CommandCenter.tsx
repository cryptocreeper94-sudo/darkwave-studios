...
const categories: CommandCategory[] = [
  ...
  },
  {
    ...
    description: "The full Trust Layer ecosystem. Browse All 37 connected applications, review codebase metrics, manage the widget marketplace, and access developer documentation.",
    cards: [
      {
        label: "Ecosystem",
        description: "All 37 connected applications with carousels",
        href: "/ecosystem",
