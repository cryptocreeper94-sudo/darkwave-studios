            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/40 border border-white/[0.08] rounded-lg px-4 py-3 text-[#050505] placeholder-gray-500 focus:border-white/[0.08] focus:outline-none transition-colors"
              ...
              <button
                onClick={handleLogin}
                className="w-full bg-white/5 border border-white/[0.08] text-[#050505] py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity"
                ...
                <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }}>
                  <GlassCard className="p-4 rounded-xl space-y-3 mb-3">
                    ...
                    <input
                      ...
                      className="w-full bg-black/40 border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-[#050505] placeholder-gray-500 focus:border-white/[0.08] focus:outline-none"
                    ...
                    <select
                      ...
                      className="w-full bg-black/40 border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-[#050505] focus:border-white/[0.08] focus:outline-none"
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-2 rounded-lg text-sm text-muted-foreground hover:text-[#050505] hover:bg-white/10 transition-colors"
                ...
                <motion.button
                  ...
                  className={`w-full text-left p-4 rounded-xl border transition-all duration-200 ${
                    selectedSlug === comp.slug
                      ...
                      : "bg-white/[0.03] border-white/[0.08] hover:border-white/[0.1] hover:bg-[#050505]/[0.06]"
                  }`}
                  whileHover={{ x: 4 }}
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between flex-wrap gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 bg-white/5 border border-white/[0.08] text-[#050505] px-4 py-1.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity disabled:opacity-40"
                ...
                {([
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-lg text-sm font-medium transition-all ${
                      activeTab === tab.id ? "bg-primary/20 text-primary" : "text-muted-foreground hover:text-[#050505] hover:bg-white/5"
                    }`}
                  ...
                  <div className="p-4 max-h-[600px] overflow-y-auto">
                    {activeTab === "form" ? (
                          ...
                          <div key={field.key}>
                            ...
                            {field.type === "textarea" ? (
                              <textarea
                                ...
                                rows={3}
                                className="w-full bg-black/40 border border-white/[0.08] rounded-lg px-3 py-2 text-sm text-[#050505] placeholder-gray-500 focus:border-white/[0.08] focus:outline-none resize-none"
                      ...
                      <textarea
                        ...
                        className="w-full h-[520px] bg-black/60 border border-white/[0.08] rounded-lg px-4 py-3 text-sm text-green-300 font-mono placeholder-gray-600 focus:border-white/[0.08] focus:outline-none resize-none leading-relaxed"
                        spellCheck={false}
                  ...
                  <div className="p-4 border-b border-white/[0.08] flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 bg-black/40 rounded-lg p-0.5">
                      <button
                        ...
                        className={`px-3 py-1 rounded-md text-xs font-medium transition-colors ${previewTheme === "dark" ? "bg-white/10 text-[#050505]" : "text-muted-foreground"}`}
                      ...
                      <button
                        ...
                        className={`px-3 py-1 rounded-md text-xs font-medium transition-colors ${previewTheme === "light" ? "bg-white/10 text-[#050505]" : "text-muted-foreground"}`}
              ...
              <GlassCard className="p-4 rounded-xl">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Or fetch directly: <code className="text-[#888]">GET /api/ecosystem/shared/render/{selected.slug}?theme=dark</code>
                </p>
              </GlassCard>
            </div>
          ) : (
