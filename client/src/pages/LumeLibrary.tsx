...
function StatusMonitorWidget() {
  ...
  const statusIcon = (s: string) => {
    ...
    return <RefreshCw className="w-3 h-3 text-gray-600 animate-spin" />;
  };
    ...
    <div className="space-y-3">
      ...
      {services.map((s, i) => (
        <div key={i} className={`flex items-center justify-between py-1.5 px-2.5 rounded-lg transition-all duration-500 ${
          ...
          s.status === "healed" ? "bg-black/5 border border-black/10" :
      ...
      {isHealing && (
        <motion.div
          ...
          className="text-[10px] text-gray-600 text-center py-1.5 bg-black/5 rounded-lg border border-black/10"
        >
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 pt-1">
        <div className="bg-black/[0.03] rounded-lg p-2 text-center border border-black/5">
  ...
  return (
    <div className="flex flex-col items-center gap-3 py-4">
      <motion.div
        ...
        className="relative"
      >
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-sky-500/20 border border-black/10 flex items-center justify-center">
...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="absolute top-3 right-3 p-1.5 rounded-lg bg-black/5 hover:bg-black/10 border border-black/10 transition-all"
    >
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-foreground overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-2xl bg-[#f8f9fa]/60 border-b border-black/5">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/lume" className="w-10 h-10 rounded-xl bg-black/5 border border-black/10 flex items-center justify-center hover:bg-black/10 hover:border-primary/50 transition-all duration-300">
              <ArrowLeft className="w-5 h-5" />
            </Link>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-black/5 border border-black/10 flex items-center justify-center shadow-lg shadow-cyan-500/25">
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-black/5 border border-black/10 text-sm text-[#050505]/60 hover:text-[#050505] hover:bg-black/10 transition-all"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-black/5 border border-black/10 text-[#050505] text-sm font-semibold shadow-lg shadow-cyan-500/25 hover:shadow-xl transition-all hover:scale-105"
            >
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        >
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-cyan-500/20 to-teal-500/20 border border-black/10 text-sm font-semibold text-gray-600 mb-8 shadow-lg shadow-cyan-500/10">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-8">
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/5 border border-black/10 text-xs text-[#050505]/50">
          ...
          {widgets.map(w => (
            <button
              ...
              className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${
                activeWidget === w.id
                  ? "bg-gradient-to-r from-cyan-500/15 to-teal-500/15 border border-black/10 text-gray-600 shadow-lg shadow-cyan-500/10"
                  : "bg-black/5 border border-black/10 text-[#050505]/50 hover:text-[#050505]/70 hover:bg-[#f8f9fa]/8"
              }`}
            >
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              {active.tags.map(tag => (
                <span key={tag} className="px-2.5 py-1 rounded-lg bg-black/5 border border-black/10 text-[10px] font-mono text-gray-600">
                  {tag}
                </span>
              ))}
            </div>
        ...
        >
          <h2 className="text-2xl lg:text-4xl font-display font-bold text-center mb-4">
            <span className="bg-black/5 border border-black/10 bg-clip-text text-transparent">
              Why Self-Healing?
            </span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <GlassCard key={i} glow className="p-6 text-center relative overflow-hidden">
                ...
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-500/15 to-teal-500/15 border border-black/10 flex items-center justify-center mx-auto mb-4">
        ...
        >
          <GlassCard glow className="p-8 lg:p-12 max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link
                href="/lume/playground"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-black/5 border border-black/10 text-[#050505] font-semibold shadow-lg shadow-cyan-500/25 hover:shadow-xl transition-all hover:scale-105"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-black/5 border border-black/10 text-[#050505]/70 font-semibold hover:bg-black/10 transition-all"
              >
