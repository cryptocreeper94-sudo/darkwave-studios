            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { name: "TechCrunch", url: "https://techcrunch.com/submit-a-tip/", type: "Tip submission form", pitch: "Full-stack ecosystem with 42 production apps and 13.7M+ lines of code", icon: Zap },
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { name: "SaaStr", url: "https://www.saastr.com", type: "SaaS community + events", pitch: "42-app ecosystem with widget marketplace, subscription model, and AI credits system", icon: TrendingUp },
              ...
              <div className="mt-8 p-6 rounded-xl bg-gradient-to-r from-primary/5 to-accent/5 border border-primary/10">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    {[
                      "Lead with the story — solo developer building a 42-app, 13.7M+ line ecosystem is compelling and rare",
