            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { name: "TechCrunch", url: "https://techcrunch.com/submit-a-tip/", type: "Tip submission form", pitch: "Full-stack ecosystem with 42 production apps and 1.86M+ lines of code", icon: Zap },
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    { name: "Decrypt", url: "https://decrypt.co/contact", type: "Story pitches", pitch: "Real-world blockchain utility — 42 Apps verified through Trust Layer", icon: Boxes },
